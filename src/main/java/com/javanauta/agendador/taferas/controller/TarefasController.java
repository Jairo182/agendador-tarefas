package com.javanauta.agendador.taferas.controller;

import com.javanauta.agendador.taferas.business.TarefasService;
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    public ResponseEntity<List<TarefasDTO>> buscarListaDeUsuarioPorPeriodo(
    ...
    public ResponseEntity<List<TarefasDTO>> buscaTarefasPorEmail(
        ...
        List<TarefasDTO> tarefas =
                tarefasService.buscarTarefasPorEmail(token);
